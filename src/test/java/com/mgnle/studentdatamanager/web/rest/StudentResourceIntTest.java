...
import com.mgnle.studentdatamanager.repository.StudentRepository;
...
public class StudentResourceIntTest {
    ...
    private static final Integer DEFAULT_CURRENT_GRADE_LEVEL = 1;
    private static final Integer UPDATED_CURRENT_GRADE_LEVEL = 2;
    ...
    public static Student createEntity(EntityManager em) {
        Student student = new Student()
            ...
            .currentGradeLevel(DEFAULT_CURRENT_GRADE_LEVEL)
    ...
    public void createStudent() throws Exception {
        ...
        assertThat(testStudent.getCurrentGradeLevel()).isEqualTo(DEFAULT_CURRENT_GRADE_LEVEL);
    ...
    @Test
    @Transactional
    public void checkCurrentGradeLevelIsRequired() throws Exception {
        int databaseSizeBeforeTest = studentRepository.findAll().size();
        // set the field null
        student.setCurrentGradeLevel(null);
    ...
    public void getAllStudents() throws Exception {
        ...
        restStudentMockMvc.perform(get("/api/students?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].currentGradeLevel").value(hasItem(DEFAULT_CURRENT_GRADE_LEVEL)))
    ...
    public void getStudent() throws Exception {
        ...
        restStudentMockMvc.perform(get("/api/students/{id}", student.getId()))
            ...
            .andExpect(jsonPath("$.currentGradeLevel").value(DEFAULT_CURRENT_GRADE_LEVEL))
    ...
    public void updateStudent() throws Exception {
        ...
        updatedStudent
            ...
            .currentGradeLevel(UPDATED_CURRENT_GRADE_LEVEL)
        ...
        assertThat(testStudent.getCurrentGradeLevel()).isEqualTo(UPDATED_CURRENT_GRADE_LEVEL);
